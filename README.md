...
- Download NASDAQ latest components via [ftp://ftp.nasdaqtrader.com/symboldirectory/](ftp://ftp.nasdaqtrader.com/symboldirectory/) into `Indices/nasdaqlisted.csv`
- Download NASDAQ Other Listed components via [ftp://ftp.nasdaqtrader.com/symboldirectory/](ftp://ftp.nasdaqtrader.com/symboldirectory/) into `Indices/otherlisted.csv`
