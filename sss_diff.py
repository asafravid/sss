                        ...
                        if abs(row_in_older_file - row_index) > movement_threshold:
                            ...
                            if not diff_only_recommendation: #                                                                             sss_value=row[3], ssss_value=row[4], sssss_value=row[5], ssse_value=row[6], sssse_value=row[7], ssssse_value=row[8], sssi_value=row[9], ssssi_value=row[10],sssssi_value=row[11],sssei_value=row[12],ssssei_value=row[13],sssssei_value=row[14],annualized_revenue=row[15],annualized_earnings=row[16],enterprise_value_to_revenue=row[17],evr_effective=row[18],trailing_price_to_earnings=row[19],trailing_12months_price_to_sales=row[20],tpe_effective=row[21],enterprise_value_to_ebitda=row[22],profit_margin=row[23],annualized_profit_margin=row[24],held_percent_institutions=row[25],forward_eps=row[26],trailing_eps=row[27],previous_close=row[28],trailing_eps_percentage=row[29],price_to_book=row[30],shares_outstanding=row[31],net_income_to_common_shareholders=row[32],nitcsh_to_shares_outstanding=row[33],num_employees=row[34],enterprise_value=row[35],nitcsh_to_num_employees=row[36],earnings_quarterly_growth=row[37],price_to_earnings_to_growth_ratio=row[38],sqrt_peg_ratio=row[39],annualized_cash_flow_from_operating_activities=row[40],ev_to_cfo_ratio=row[41],last_4_dividends_0=row[42],last_4_dividends_1=row[43],last_4_dividends_2=row[44],last_4_dividends_3=row[45]
                                ...
                                print('                                                                                    From            sss_value: {:15}, ssss_value: {:15}, sssss_value: {:15}, ssse_value: {:15}, sssse_value: {:15}, ssssse_value: {:15}, sssi_value: {:15}, ssssi_value: {:15}, sssssi_value: {:15}, sssei_value: {:15}, ssssei_value: {:15}, sssssei_value: {:15}, annualized_revenue: {:15}, annualized_earnings: {:15}, enterprise_value_to_revenue: {:15}, evr_effective: {:15}, trailing_price_to_earnings: {:15}, trailing_12months_price_to_sales: {15:}, tpe_effective: {:15}, enterprise_value_to_ebitda: {:15}, profit_margin: {:15}, annualized_profit_margin: {:15}, held_percent_institutions: {:15}, forward_eps: {:15}, trailing_eps: {:15}, previous_close: {:15}, trailing_eps_percentage: {:15}, price_to_book: {:15}, shares_outstanding: {:15}, net_income_to_common_shareholders: {:15}, nitcsh_to_shares_outstanding: {:15}, num_employees: {:15}, enterprise_value: {:15}, nitcsh_to_num_employees: {:15}, earnings_quarterly_growth: {:15}, price_to_earnings_to_growth_ratio: {:15}, sqrt_peg_ratio: {:15}, annualized_cash_flow_from_operating_activities: {:15}, ev_to_cfo_ratio: {:15}'.format(
                                                                                                                                           oldr[3],          oldr[4],           oldr[5],            oldr[6],           oldr[7],            oldr[8],             oldr[9],           oldr[10],           oldr[11],            oldr[12],           oldr[13],            oldr[14],             oldr[15],                  oldr[16],                   oldr[17],                           oldr[18],             older[19],                         oldr[20],                                oldr[21],             oldr[22],                          oldr[23],             oldr[24],                        oldr[25],                         oldr[26],           oldr[27],            oldr[28],              oldr[29],                       oldr[30],             oldr[31],                  oldr[32],                                 oldr[33],                            oldr[34],             oldr[35],                oldr[36],                       oldr[37],                         oldr[38],                                 oldr[39],              oldr[40],                                              oldr[41]))
                                print('                                                                                    To              sss_value: {:15}, ssss_value: {:15}, sssss_value: {:15}, ssse_value: {:15}, sssse_value: {:15}, ssssse_value: {:15}, sssi_value: {:15}, ssssi_value: {:15}, sssssi_value: {:15}, sssei_value: {:15}, ssssei_value: {:15}, sssssei_value: {:15}, annualized_revenue: {:15}, annualized_earnings: {:15}, enterprise_value_to_revenue: {:15}, evr_effective: {:15}, trailing_price_to_earnings: {:15}, trailing_12months_price_to_sales: {15:}, tpe_effective: {:15}, enterprise_value_to_ebitda: {:15}, profit_margin: {:15}, annualized_profit_margin: {:15}, held_percent_institutions: {:15}, forward_eps: {:15}, trailing_eps: {:15}, previous_close: {:15}, trailing_eps_percentage: {:15}, price_to_book: {:15}, shares_outstanding: {:15}, net_income_to_common_shareholders: {:15}, nitcsh_to_shares_outstanding: {:15}, num_employees: {:15}, enterprise_value: {:15}, nitcsh_to_num_employees: {:15}, earnings_quarterly_growth: {:15}, price_to_earnings_to_growth_ratio: {:15}, sqrt_peg_ratio: {:15}, annualized_cash_flow_from_operating_activities: {:15}, ev_to_cfo_ratio: {:15}'.format(
                                                                                                                                           row[3],           row[4],            row[5],             row[6],            row[7],             row[8],              row[9],            row[10],            row[11],             row[12],            row[13],             row[14],              row[15],                   row[16],                    row[17],                            row[18],              row[19],                           row[20],                                 row[21],              row[22],                           row[23],              row[24],                         row[25],                          row[26],            row[27],             row[28],               row[29],                        row[30],              row[31],                   row[32],                                  row[33],                             row[34],              row[35],                 row[36],                        row[37],                          row[38],                                  row[39],               row[40],                                               row[41] ))
