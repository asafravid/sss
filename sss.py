...
READ_NASDAQ_INPUT_SYMBOLS         = 1
MIN_ENTERPRISE_VALUE              = 0            # TODO: ASAFR: Make it 500,000,000$?
NUM_THREADS                       = 2            # 1..5 Threads are supported
...
TASE_PROFIT_MARGIN                = 0.10
PROFIT_MARGIN_LIMIT               = 0.12         # TODO: ASAFR: + 0.13*READ_NASDAQ_INPUT_SYMBOLS
...
# Temporary for test:
# symbols = ['IGLD-M.TA', 'ALMA.TA', 'EMDV.TA', 'ISTA.TA', 'ALD.TA', 'ADGR.TA', 'HOLX', 'SKLN.TA', 'ALMA.TA', 'BR', 'GDI', 'LOGM', 'WRK', 'EBAY', 'RSPP', 'FB', 'AL', 'INTC', 'AES', 'MMM', 'ADBE', 'MS']
...
date_and_time = time.strftime("Results/%Y%m%d-%H%M%S{}{}{}".format(tase_str, sectors_str, all_str))
