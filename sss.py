...
INTERVAL_SECS_TO_AVOID_HTTP_ERRORS = 60*(7 - 1*TASE_MODE + 29*READ_UNITED_STATES_INPUT_SYMBOLS)         # Every INTERVAL_THREADS, a INTERVALS_TO_AVOID_HTTP_ERRORS sec sleep will take place
