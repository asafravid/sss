#############################################################################
#
# Version 0.0.365 - Author: Asaf Ravid <asaf.rvd@gmail.com>
#
...
# TODO: ASAF: 0. Fix This in yfinance: (tase) IGLD-M.TA: 1d data not available for startTime=-2208988800 and endTime=1617487283. Only 100 years worth of day granularity data are allowed to be fetched per request.
...
g_earnings_quarterly_growth_index                       = g_header_row.index("earnings_quarterly_growth")
...
g_annualized_total_liab_index                           = g_header_row.index("annualized_total_liab")
...
g_quarterized_total_liab_index                          = g_header_row.index("quarterized_total_liab")
    ...
    try:
        ...
        if build_csv_db:
            ...
            try:
                ...
                print("Exception in {} balance_sheets: {}".format(stock_data.symbol, e))
            ...
            try:
                ...
                print("Exception in {} balance_sheets_quarterly: {}".format(stock_data.symbol, e))
        ...
        #     if return_value and (not research_mode or VERBOSE_LOGS): print('                            Skipping {} revenue_quarterly_growth: {}'.format(stock_data.symbol, stock_data.revenue_quarterly_growth))
        #     return_value = False
        ...
        if build_csv_db:
            ...
            if stock_data.employees                                   is not None: stock_data.employees                                   = round(stock_data.employees,                                   NUM_ROUND_DECIMALS)
...
def process_symbols(symbols, csv_db_data, rows, rows_no_div, rows_only_div, thread_id, build_csv_db_only, use_investpy, tase_mode, sectors_list, sectors_filter_out, countries_list, countries_filter_out, build_csv_db, relaxed_access, profit_margin_limit, ev_to_cfo_ratio_limit, debt_to_equity_limit, min_enterprise_value_millions_usd, earnings_quarterly_growth_min, revenue_quarterly_growth_min, price_to_earnings_limit, enterprise_value_to_revenue_limit, favor_sectors, favor_sectors_by, market_cap_included, research_mode, currency_conversion_tool):
    ...
    if build_csv_db:
        for symb in symbols:
            ...
            rows.append(                           [stock_data.symbol, stock_data.short_name, stock_data.sector, stock_data.country, stock_data.sss_value, stock_data.annualized_revenue, stock_data.annualized_earnings, stock_data.quarterized_revenue, stock_data.quarterized_earnings, stock_data.effective_earnings, stock_data.effective_revenue, stock_data.enterprise_value_to_revenue, stock_data.evr_effective, stock_data.trailing_price_to_earnings, stock_data.forward_price_to_earnings, stock_data.effective_price_to_earnings, stock_data.trailing_12months_price_to_sales, stock_data.pe_effective, stock_data.enterprise_value_to_ebitda, stock_data.profit_margin, stock_data.annualized_profit_margin, stock_data.annualized_profit_margin_boost, stock_data.quarterized_profit_margin, stock_data.quarterized_profit_margin_boost, stock_data.effective_profit_margin, stock_data.held_percent_institutions, stock_data.forward_eps, stock_data.trailing_eps, stock_data.previous_close, stock_data.trailing_eps_percentage, stock_data.price_to_book, stock_data.shares_outstanding, stock_data.net_income_to_common_shareholders, stock_data.nitcsh_to_shares_outstanding, stock_data.employees, stock_data.enterprise_value, stock_data.market_cap, stock_data.nitcsh_to_num_employees, stock_data.earnings_quarterly_growth, stock_data.revenue_quarterly_growth, stock_data.price_to_earnings_to_growth_ratio, stock_data.effective_peg_ratio, stock_data.annualized_cash_flow_from_operating_activities, stock_data.quarterized_cash_flow_from_operating_activities, stock_data.annualized_ev_to_cfo_ratio, stock_data.quarterized_ev_to_cfo_ratio, stock_data.ev_to_cfo_ratio_effective, stock_data.annualized_total_liab, stock_data.annualized_total_stockholder_equity, stock_data.annualized_debt_to_equity, stock_data.quarterized_total_liab, stock_data.quarterized_total_stockholder_equity, stock_data.quarterized_debt_to_equity, stock_data.debt_to_equity_effective, stock_data.financial_currency, stock_data.conversion_rate_mult_to_usd, stock_data.last_dividend_0, stock_data.last_dividend_1, stock_data.last_dividend_2, stock_data.last_dividend_3, stock_data.fifty_two_week_change, stock_data.fifty_two_week_low, stock_data.fifty_two_week_high, stock_data.two_hundred_day_average, stock_data.previous_close_percentage_from_200d_ma, stock_data.previous_close_percentage_from_52w_low, stock_data.previous_close_percentage_from_52w_high, stock_data.dist_from_low_factor, stock_data.eff_dist_from_low_factor])
            if dividends_sum: rows_only_div.append([stock_data.symbol, stock_data.short_name, stock_data.sector, stock_data.country, stock_data.sss_value, stock_data.annualized_revenue, stock_data.annualized_earnings, stock_data.quarterized_revenue, stock_data.quarterized_earnings, stock_data.effective_earnings, stock_data.effective_revenue, stock_data.enterprise_value_to_revenue, stock_data.evr_effective, stock_data.trailing_price_to_earnings, stock_data.forward_price_to_earnings, stock_data.effective_price_to_earnings, stock_data.trailing_12months_price_to_sales, stock_data.pe_effective, stock_data.enterprise_value_to_ebitda, stock_data.profit_margin, stock_data.annualized_profit_margin, stock_data.annualized_profit_margin_boost, stock_data.quarterized_profit_margin, stock_data.quarterized_profit_margin_boost, stock_data.effective_profit_margin, stock_data.held_percent_institutions, stock_data.forward_eps, stock_data.trailing_eps, stock_data.previous_close, stock_data.trailing_eps_percentage, stock_data.price_to_book, stock_data.shares_outstanding, stock_data.net_income_to_common_shareholders, stock_data.nitcsh_to_shares_outstanding, stock_data.employees, stock_data.enterprise_value, stock_data.market_cap, stock_data.nitcsh_to_num_employees, stock_data.earnings_quarterly_growth, stock_data.revenue_quarterly_growth, stock_data.price_to_earnings_to_growth_ratio, stock_data.effective_peg_ratio, stock_data.annualized_cash_flow_from_operating_activities, stock_data.quarterized_cash_flow_from_operating_activities, stock_data.annualized_ev_to_cfo_ratio, stock_data.quarterized_ev_to_cfo_ratio, stock_data.ev_to_cfo_ratio_effective, stock_data.annualized_total_liab, stock_data.annualized_total_stockholder_equity, stock_data.annualized_debt_to_equity, stock_data.quarterized_total_liab, stock_data.quarterized_total_stockholder_equity, stock_data.quarterized_debt_to_equity, stock_data.debt_to_equity_effective, stock_data.financial_currency, stock_data.conversion_rate_mult_to_usd, stock_data.last_dividend_0, stock_data.last_dividend_1, stock_data.last_dividend_2, stock_data.last_dividend_3, stock_data.fifty_two_week_change, stock_data.fifty_two_week_low, stock_data.fifty_two_week_high, stock_data.two_hundred_day_average, stock_data.previous_close_percentage_from_200d_ma, stock_data.previous_close_percentage_from_52w_low, stock_data.previous_close_percentage_from_52w_high, stock_data.dist_from_low_factor, stock_data.eff_dist_from_low_factor])
            else:             rows_no_div.append(  [stock_data.symbol, stock_data.short_name, stock_data.sector, stock_data.country, stock_data.sss_value, stock_data.annualized_revenue, stock_data.annualized_earnings, stock_data.quarterized_revenue, stock_data.quarterized_earnings, stock_data.effective_earnings, stock_data.effective_revenue, stock_data.enterprise_value_to_revenue, stock_data.evr_effective, stock_data.trailing_price_to_earnings, stock_data.forward_price_to_earnings, stock_data.effective_price_to_earnings, stock_data.trailing_12months_price_to_sales, stock_data.pe_effective, stock_data.enterprise_value_to_ebitda, stock_data.profit_margin, stock_data.annualized_profit_margin, stock_data.annualized_profit_margin_boost, stock_data.quarterized_profit_margin, stock_data.quarterized_profit_margin_boost, stock_data.effective_profit_margin, stock_data.held_percent_institutions, stock_data.forward_eps, stock_data.trailing_eps, stock_data.previous_close, stock_data.trailing_eps_percentage, stock_data.price_to_book, stock_data.shares_outstanding, stock_data.net_income_to_common_shareholders, stock_data.nitcsh_to_shares_outstanding, stock_data.employees, stock_data.enterprise_value, stock_data.market_cap, stock_data.nitcsh_to_num_employees, stock_data.earnings_quarterly_growth, stock_data.revenue_quarterly_growth, stock_data.price_to_earnings_to_growth_ratio, stock_data.effective_peg_ratio, stock_data.annualized_cash_flow_from_operating_activities, stock_data.quarterized_cash_flow_from_operating_activities, stock_data.annualized_ev_to_cfo_ratio, stock_data.quarterized_ev_to_cfo_ratio, stock_data.ev_to_cfo_ratio_effective, stock_data.annualized_total_liab, stock_data.annualized_total_stockholder_equity, stock_data.annualized_debt_to_equity, stock_data.quarterized_total_liab, stock_data.quarterized_total_stockholder_equity, stock_data.quarterized_debt_to_equity, stock_data.debt_to_equity_effective, stock_data.financial_currency, stock_data.conversion_rate_mult_to_usd, stock_data.last_dividend_0, stock_data.last_dividend_1, stock_data.last_dividend_2, stock_data.last_dividend_3, stock_data.fifty_two_week_change, stock_data.fifty_two_week_low, stock_data.fifty_two_week_high, stock_data.two_hundred_day_average, stock_data.previous_close_percentage_from_200d_ma, stock_data.previous_close_percentage_from_52w_low, stock_data.previous_close_percentage_from_52w_high, stock_data.dist_from_low_factor, stock_data.eff_dist_from_low_factor])
            csv_db_data.append(                    [stock_data.symbol, stock_data.short_name, stock_data.sector, stock_data.country, stock_data.sss_value, stock_data.annualized_revenue, stock_data.annualized_earnings, stock_data.quarterized_revenue, stock_data.quarterized_earnings, stock_data.effective_earnings, stock_data.effective_revenue, stock_data.enterprise_value_to_revenue, stock_data.evr_effective, stock_data.trailing_price_to_earnings, stock_data.forward_price_to_earnings, stock_data.effective_price_to_earnings, stock_data.trailing_12months_price_to_sales, stock_data.pe_effective, stock_data.enterprise_value_to_ebitda, stock_data.profit_margin, stock_data.annualized_profit_margin, stock_data.annualized_profit_margin_boost, stock_data.quarterized_profit_margin, stock_data.quarterized_profit_margin_boost, stock_data.effective_profit_margin, stock_data.held_percent_institutions, stock_data.forward_eps, stock_data.trailing_eps, stock_data.previous_close, stock_data.trailing_eps_percentage, stock_data.price_to_book, stock_data.shares_outstanding, stock_data.net_income_to_common_shareholders, stock_data.nitcsh_to_shares_outstanding, stock_data.employees, stock_data.enterprise_value, stock_data.market_cap, stock_data.nitcsh_to_num_employees, stock_data.earnings_quarterly_growth, stock_data.revenue_quarterly_growth, stock_data.price_to_earnings_to_growth_ratio, stock_data.effective_peg_ratio, stock_data.annualized_cash_flow_from_operating_activities, stock_data.quarterized_cash_flow_from_operating_activities, stock_data.annualized_ev_to_cfo_ratio, stock_data.quarterized_ev_to_cfo_ratio, stock_data.ev_to_cfo_ratio_effective, stock_data.annualized_total_liab, stock_data.annualized_total_stockholder_equity, stock_data.annualized_debt_to_equity, stock_data.quarterized_total_liab, stock_data.quarterized_total_stockholder_equity, stock_data.quarterized_debt_to_equity, stock_data.debt_to_equity_effective, stock_data.financial_currency, stock_data.conversion_rate_mult_to_usd, stock_data.last_dividend_0, stock_data.last_dividend_1, stock_data.last_dividend_2, stock_data.last_dividend_3, stock_data.fifty_two_week_change, stock_data.fifty_two_week_low, stock_data.fifty_two_week_high, stock_data.two_hundred_day_average, stock_data.previous_close_percentage_from_200d_ma, stock_data.previous_close_percentage_from_52w_low, stock_data.previous_close_percentage_from_52w_high, stock_data.dist_from_low_factor, stock_data.eff_dist_from_low_factor])
            ...
            for fix_row_index in range(g_country_index+1,len(row)):  # for empty strings - convert value to 0
                if row[fix_row_index] == '':
                    if fix_row_index == g_name_index:  # Name == '' --> 'None'
                        ...
                        row[fix_row_index] = 0
            stock_data = StockData(symbol=symbol, short_name=row[g_name_index], sector=row[g_sector_index], country=row[g_country_index], sss_value=float(row[g_sss_value_index]), annualized_revenue=float(row[g_annualized_revenue_index]), annualized_earnings=float(row[g_annualized_earnings_index]), quarterized_revenue=float(row[g_quarterized_revenue_index]), quarterized_earnings=float(row[g_quarterized_earnings_index]), effective_earnings=float(row[g_effective_earnings_index]), effective_revenue=float(row[g_effective_revenue_index]), enterprise_value_to_revenue=float(row[g_enterprise_value_to_revenue_index]), evr_effective=float(row[g_evr_effective_index]), trailing_price_to_earnings=float(row[g_trailing_price_to_earnings_index]), forward_price_to_earnings=float(row[g_forward_price_to_earnings_index]), effective_price_to_earnings=float(row[g_effective_price_to_earnings_index]), trailing_12months_price_to_sales=float(row[g_trailing_12months_price_to_sales_index]), pe_effective=float(row[g_pe_effective_index]), enterprise_value_to_ebitda=float(row[g_enterprise_value_to_ebitda_index]), profit_margin=float(row[g_profit_margin_index]), annualized_profit_margin=float(row[g_annualized_profit_margin_index]), annualized_profit_margin_boost=float(row[g_annualized_profit_margin_boost_index]), quarterized_profit_margin=float(row[g_quarterized_profit_margin_index]), quarterized_profit_margin_boost=float(row[g_quarterized_profit_margin_boost_index]), effective_profit_margin=float(row[g_effective_profit_margin_index]), held_percent_institutions=float(row[g_held_percent_institutions_index]), forward_eps=float(row[g_forward_eps_index]), trailing_eps=float(row[g_trailing_eps_index]), previous_close=float(row[g_previous_close_index]), trailing_eps_percentage=float(row[g_trailing_eps_percentage_index]), price_to_book=float(row[g_price_to_book_index]), shares_outstanding=float(row[g_shares_outstanding_index]), net_income_to_common_shareholders=float(row[g_net_income_to_common_shareholders_index]), nitcsh_to_shares_outstanding=float(row[g_nitcsh_to_shares_outstanding_index]), employees=int(float(row[g_employees_index])), enterprise_value=int(float(row[g_enterprise_value_index])), market_cap=int(float(row[g_market_cap_index])), nitcsh_to_num_employees=float(row[g_nitcsh_to_num_employees_index]), earnings_quarterly_growth=float(row[g_earnings_quarterly_growth_index]), revenue_quarterly_growth=float(row[g_revenue_quarterly_growth_index]), price_to_earnings_to_growth_ratio=float(row[g_price_to_earnings_to_growth_ratio_index]), effective_peg_ratio=float(row[g_effective_peg_ratio_index]), annualized_cash_flow_from_operating_activities=float(row[g_annualized_cash_flow_from_operating_activities_index]), quarterized_cash_flow_from_operating_activities=float(row[g_quarterized_cash_flow_from_operating_activities_index]), annualized_ev_to_cfo_ratio=float(row[g_annualized_ev_to_cfo_ratio_index]), quarterized_ev_to_cfo_ratio=float(row[g_quarterized_ev_to_cfo_ratio_index]), ev_to_cfo_ratio_effective=float(row[g_ev_to_cfo_ratio_effective_index]), annualized_total_liab=float(row[g_annualized_total_liab_index]), annualized_total_stockholder_equity=float(row[g_annualized_total_stockholder_equity_index]), annualized_debt_to_equity=float(row[g_annualized_debt_to_equity_index]), quarterized_total_liab=float(row[g_quarterized_total_liab_index]), quarterized_total_stockholder_equity=float(row[g_quarterized_total_stockholder_equity_index]), quarterized_debt_to_equity=float(row[g_quarterized_debt_to_equity_index]), debt_to_equity_effective=float(row[g_debt_to_equity_effective_index]), financial_currency=row[g_financial_currency_index], conversion_rate_mult_to_usd=float(row[g_conversion_rate_mult_to_usd_index]), last_dividend_0=float(row[g_last_dividend_0_index]), last_dividend_1=float(row[g_last_dividend_1_index]), last_dividend_2=float(row[g_last_dividend_2_index]), last_dividend_3=float(row[g_last_dividend_3_index]), fifty_two_week_change=float(row[g_fifty_two_week_change_index]), fifty_two_week_low=float(row[g_fifty_two_week_low_index]), fifty_two_week_high=float(row[g_fifty_two_week_high_index]), two_hundred_day_average=float(row[g_two_hundred_day_average_index]), previous_close_percentage_from_200d_ma=float(row[g_previous_close_percentage_from_200d_ma_index]), previous_close_percentage_from_52w_low=float(row[g_previous_close_percentage_from_52w_low_index]), previous_close_percentage_from_52w_high=float(row[g_previous_close_percentage_from_52w_high_index]), dist_from_low_factor=float(row[g_dist_from_low_factor_index]), eff_dist_from_low_factor=float(row[g_eff_dist_from_low_factor_index]))
...
def sss_run(sectors_list, sectors_filter_out, countries_list, countries_filter_out,build_csv_db_only, build_csv_db, csv_db_path, read_united_states_input_symbols, tase_mode, num_threads, market_cap_included, use_investpy, research_mode, profit_margin_limit, ev_to_cfo_ratio_limit, debt_to_equity_limit, min_enterprise_value_millions_usd, price_to_earnings_limit, enterprise_value_to_revenue_limit, favor_sectors, favor_sectors_by, generate_result_folders=1, appearance_counter_dict_sss={}, appearance_counter_min=25, appearance_counter_max=35, custom_portfolio=[]):
    ...
    sorted_list_db               = sorted(csv_db_data,           key=lambda row:          row[g_symbol_index],                 reverse=False)  # Sort by symbol symbol
