#############################################################################
#
# Version 0.1.31 - Author: Asaf Ravid <asaf.rvd@gmail.com>
#
...
run_custom_tase = True   # Custom Portfolio
run_custom      = False
...
if not research_mode: # Run Build DB Only:
    ...
    if run_tase:
        new_run = 'Results/Tase/20210603-231310_Tase_Tchnlgy3.0_RlEstt1.0_Bdb_nRes292'
    ...
    if run_nsr:
        new_run = 'Results/Nsr/20210601-013209_Tchnlgy3.0_FnnclSrvcs0.5_Bdb_nRes864'
