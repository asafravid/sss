#############################################################################
#
# Version 0.0.583 - Author: Asaf Ravid <asaf.rvd@gmail.com>
#
...
if not research_mode: # Run Build DB Only:
    ...
    if run_tase:
        new_run = 'Results/Tase/20210429-201544_Tase_RlEstt_Bdb_nRes44'
