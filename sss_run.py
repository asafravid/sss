...
# Research Mode:
# ==============
def research_db(min_evr, max_evr, pm_min, pm_max, csv_db_path, mode_str, read_united_states_input_symbols, tase_mode, forward_eps_included, generate_result_folders, appearance_counter_dict):
...
# TASE:
# =====
csv_db_path='Results/20201115-145013_TASE_FAVOR_TECH_BY3_MARKETCAP_PMARGIN0.0567_EVR15.0_BUILD_DB_ONLY_NUM_RESULTS_443'
appearance_counter_dict = {}
prepare_appearance_counters_dictionary(csv_db_path, appearance_counter_dict)
research_db(min_evr=1, max_evr=25, pm_min=5, pm_max=45, csv_db_path=csv_db_path,    mode_str='TASE_',                        read_united_states_input_symbols=0, tase_mode=1, forward_eps_included=0, generate_result_folders=0, appearance_counter_dict=appearance_counter_dict)
...
# ============================
csv_db_path='Results/20201115-043117_FAVOUR_TECH_BY3_MARKETCAP_FORWARDEPS_PMARGIN0.17_EVR17.5_BUILD_DB_ONLY_NUM_RESULTS_1115'
appearance_counter_dict = {}
prepare_appearance_counters_dictionary(csv_db_path, appearance_counter_dict)
research_db(min_evr=1, max_evr=25, pm_min=10, pm_max=45, csv_db_path=csv_db_path,   mode_str='NASDAQ100_RUSSEL1000_SNP500_', read_united_states_input_symbols=0, tase_mode=0, forward_eps_included=0, generate_result_folders=0, appearance_counter_dict=appearance_counter_dict)
sorted_appearance_counter_dict = {k: v for k, v in sorted(appearance_counter_dict.items(), key=lambda item: item[1], reverse=True)}


# ALL:
# ====
csv_db_path='Results/20201116-044930_FAVOR_TECH_BY3_OTHERS_MARKETCAP_FORWARDEPS_PMARGIN0.24_EVR15.0_BUILD_DB_ONLY_NUM_RESULTS_8401'
appearance_counter_dict = {}
prepare_appearance_counters_dictionary(csv_db_path, appearance_counter_dict)
research_db(min_evr=1, max_evr=20, pm_min= 5, pm_max=45, csv_db_path=csv_db_path,   mode_str='ALL_',                         read_united_states_input_symbols=1, tase_mode=0, forward_eps_included=1, generate_result_folders=0, appearance_counter_dict=appearance_counter_dict)
sorted_appearance_counter_dict = {k: v for k, v in sorted(appearance_counter_dict.items(), key=lambda item: item[1], reverse=True)}
