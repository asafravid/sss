...
def research_db(min_evr, max_evr, pm_min, pm_max, csv_db_path, read_united_states_input_symbols, tase_mode, generate_result_folders, appearance_counter_min, appearance_counter_max):
    ...
    results_filename_ssss    = 'results_ssss_evr{}-{}_pm{}-{}.csv'.format(min_evr,max_evr,pm_min,pm_max)
    results_filename_sssss   = 'results_sssss_evr{}-{}_pm{}-{}.csv'.format(min_evr,max_evr,pm_min,pm_max)
    np.savetxt(csv_db_path+'/'+results_filename_ssss,  research_rows_ssss.astype(int), fmt='%d', delimiter=',')
    np.savetxt(csv_db_path+'/'+results_filename_sssss, research_rows_sssss.astype(int), fmt='%d', delimiter=',')
    title_row = list(range(pm_min,pm_max+1))
    title_row.insert(0, 'evr / pm')
    evr_rows_pm_cols_filenames_list = [csv_db_path+'/'+results_filename_ssss, csv_db_path+'/'+results_filename_sssss]
    ...
    reccomendation_list_filename_ssss = csv_db_path+'/reccomendation_ssss_'+results_filename_ssss.replace('results_','')
    ...
    reccomendation_list_filename_sssss = csv_db_path+'/reccomendation_sssss_'+results_filename_sssss.replace('results_','')
...
# TASE:
# =====
# research_db(min_evr=1, max_evr=25, pm_min=5,  pm_max=45, csv_db_path='Results/20210102-230029_Tase_FavorTechBy3_MCap_pm0.0567_evr15.0_BuildDb_nResults456',   read_united_states_input_symbols=0, tase_mode=1, generate_result_folders=0, appearance_counter_min=20, appearance_counter_max=40)
