        ...
        if run_all:
            if not sss_config.aggregate_only:
                for db_filename in DB_FILENAMES:
                    ...
                    evr_range_all         = get_range(csv_db_path=new_run_all, db_filename=db_filename, column_name='evr_effective',            num_sections=4 if sss_config.custom_sss_value_equation else 8, reverse=1, pop_1st_percentile_range=False if sss_config.custom_sss_value_equation else True)
