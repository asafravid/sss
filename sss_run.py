...
reference_run_custom = 'Results/Custom/20210426-004923_Technology3.5_FinancialServices0.5_Bdb_nRes211_Custom'
...
if not research_mode: # Run Build DB Only:
    ...
    if run_custom:      sss.sss_run(reference_run=reference_run_custom, sectors_list=[], sectors_filter_out=0, countries_list=[], countries_filter_out=0, build_csv_db_only=1, build_csv_db=1, csv_db_path='None', read_united_states_input_symbols=0, tase_mode=0, num_threads=4,  market_cap_included=1, use_investpy=0, research_mode=0, profit_margin_limit=0.0001, ev_to_cfo_ratio_limit=20000.0,  debt_to_equity_limit=1000.0, min_enterprise_value_millions_usd=5, price_to_earnings_limit=9000, enterprise_value_to_revenue_limit=2000, favor_sectors=['Technology', 'Financial Services'], favor_sectors_by=[3.5,  0.5], generate_result_folders=1, custom_portfolio=['PLD']) #['AAPL', 'ABBV', 'ABEV', 'ACGL', 'ACN', 'ACTG', 'ADBE', 'AFL', 'AGO', 'AKAM', 'AL', 'ALGN', 'ALL', 'ALLY', 'ALXN', 'AMAT', 'AMGN', 'APH', 'APT', 'ARE', 'ATH', 'ATVI', 'AVB', 'AVGO', 'AZPN', 'BABA', 'BAC', 'BBY', 'BDN', 'BIDU', 'BIO', 'BLK', 'BMRN', 'BOKF', 'BPOP', 'BRK.B', 'BTG', 'BTI', 'BWXT', 'BXP', 'CACC', 'CB', 'CDNS', 'CDW', 'CE', 'CGNX', 'CHKP', 'CI', 'CIG', 'CMCSA', 'COF', 'COO', 'COOP', 'CPB', 'CPRX', 'CROX', 'CSCO', 'CUZ', 'DAC', 'DFS', 'DG', 'DGX', 'DHI', 'DISH', 'DLB', 'DOX', 'DRE', 'EBAY', 'ELP', 'ES', 'ESGR', 'ETR', 'EXEL', 'EXR', 'FAST', 'FB', 'FCNCA', 'FCPT', 'FDUS', 'FF', 'FHN', 'FRC', 'FRO', 'FTV', 'GFI', 'GGB', 'GHC', 'GIB', 'GILD', 'GIS', 'GLPI', 'GNTX', 'GOOG', 'GOOGL', 'GPP', 'GRMN', 'GS', 'GTLS', 'GTN', 'HIW', 'HMLP', 'HOLX', 'HPQ', 'HTH', 'HUN', 'HZNP', 'ICE', 'INTC', 'INVA', 'IRCP', 'JAZZ', 'JD', 'JEF', 'JPM', 'KGC', 'KIM', 'KLAC', 'KNOP', 'LAKE', 'LDOS', 'LEN', 'LH', 'LMT', 'LOPE', 'LRCX', 'MAS', 'MCO', 'MDLZ', 'MFC', 'MGM', 'MHO', 'MMM', 'MRK', 'MRVL', 'MS', 'MSFT', 'MTH', 'MU', 'MX', 'NBIX', 'NEM', 'NGG', 'NUE', 'NVEC', 'NVO', 'NVR', 'OHI', 'OLP', 'OMF', 'OPRA', 'ORAN', 'ORCL', 'OZK', 'PB', 'PBCT', 'PBFX', 'PEG', 'PG', 'PGR', 'PHM', 'PM', 'PNFP', 'QCOM', 'QDEL', 'QRVO', 'REGN', 'RGLD', 'RIO', 'SBNY', 'SCHW', 'SCI', 'SLM', 'SMFG', 'SONY', 'SRE', 'STT', 'STZ', 'SUPN', 'SWK', 'SWKS', 'TER', 'TGT', 'TKC', 'TLK', 'TMO', 'TRNO', 'TROW', 'TROX', 'TRP', 'TRQ', 'TRV', 'TSN', 'TX', 'TXN', 'UHS', 'UI', 'UNH', 'USB', 'UTHR', 'VICI', 'VIV', 'VMW', 'VRSN', 'VRTX', 'VST', 'VZ', 'WAL', 'WMT', 'WPC', 'WPM', 'WSM', 'WTFC', 'YY'])
    ...
    if run_tase:
        new_run = 'Results/Tase/20210428-001405_Tase_Technology4.0_RealEstate0.75_Bdb_nRes258'
