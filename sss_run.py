...
def research_db(evr_range, pm_range, ev_millions_range, csv_db_path, read_united_states_input_symbols, tase_mode, generate_result_folders, appearance_counter_min, appearance_counter_max, favor_technology_sector_evr):
...
# TASE:
# =====
# old_run = 'Results/20210120-235652_Tase_FavorTechBy3_MCap_pm0.0567_evr15.0_BuildDb_nResults439'
# new_run = 'Results/20210125-013126_TaseFTB3_MCap_pm0.0567_evr15.0_BuildDb_nResults454'
# research_db(evr_range=[1,25], pm_range=[5,45], ev_millions_range=10,   csv_db_path=new_run,   read_united_states_input_symbols=0, tase_mode=1, generate_result_folders=0, appearance_counter_min=5, appearance_counter_max=65)
# sss_diff.run(newer_path=new_run, older_path=old_run, db_exists_in_both_folders=1, diff_only_recommendation=1, ticker_index=0, name_index=1, movement_threshold=3, newer_rec_ranges=[10,1,25,5,45], older_rec_ranges=[500,1,25,5,45], rec_length=60)

# NASDAQ100+S&P500+RUSSEL1000:
# ============================
old_run = 'Results/20210124-010259FTB3_MCap_pm0.17_evr17.5_BuildDb_nResults1094'
new_run = 'Results/20210125-030805_FTB4_MCap_pm0.17_evr17.5_BuildDb_nResults1094'
# research_db(evr_range=[1,45], pm_range=[5,50], ev_millions_range=100,  csv_db_path=new_run,   read_united_states_input_symbols=0, tase_mode=0, generate_result_folders=0, appearance_counter_min=5, appearance_counter_max=65, favor_technology_sector_evr=4)
sss_diff.run(newer_path=new_run, older_path=old_run, db_exists_in_both_folders=1, diff_only_recommendation=1, ticker_index=0, name_index=1, movement_threshold=3, newer_rec_ranges=[100,1,45,5,50], older_rec_ranges=[100,1,45,5,50], rec_length=60)

# Generate:
# research_db(evr_range=[7,7],  pm_range=[21,21], ev_millions_range=100, csv_db_path=new_run,   read_united_states_input_symbols=0, tase_mode=0, generate_result_folders=1, appearance_counter_min=20, appearance_counter_max=40)
...
# research_db(evr_range=[1,55], pm_range=[5,45], ev_millions_range=100, csv_db_path=new_run,  read_united_states_input_symbols=1, tase_mode=0, generate_result_folders=0, appearance_counter_min=5, appearance_counter_max=55)
# sss_diff.run(newer_path=new_run, older_path=old_run, db_exists_in_both_folders=1, diff_only_recommendation=1, ticker_index=0, name_index=1, movement_threshold=3, newer_rec_ranges=[100, 1, 55, 5, 45], older_rec_ranges=[100, 1, 55, 5, 45], rec_length=60)

# Generate ALL:
# research_db(evr_range=[7,7], pm_range=[32,32], ev_millions_range=100, csv_db_path=new_run,  read_united_states_input_symbols=1, tase_mode=0, generate_result_folders=1, appearance_counter_min=20, appearance_counter_max=40)
