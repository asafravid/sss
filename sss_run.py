...
if not research_mode: # Run Build DB Only:
    ...
    if run_tase:
        new_run = 'Results/Tase/20210524-033137_Tase_Tchnlgy3.0_RlEstt1.0_Bdb_nRes287'
